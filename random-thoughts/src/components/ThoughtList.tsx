...
const MessagesList: React.FC<MessagesListProps> = ({ messages, onLikeClick }) => {

  return (
    <div className="mt-4 space-y-4">
    {messages.map((message) => (
      <div key={message.id} className=" w-full py-6 px-8 bg-white border border-gray-200 rounded-lg shadow">
        <div className="flex justify-around items-start">
          ...
          <button 
            className="ml-4 text-red-500 hover:text-green-600 transition-colors"
